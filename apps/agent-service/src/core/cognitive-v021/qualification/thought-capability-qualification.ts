  ...
  operationCapabilities: [
    {
      ...
      description: "Read bounded evidence from the approved qualification project.",
      inputContract: "Requires projectId and may include a bounded locator.",
      outputContract: "Returns a read-only observation with bounded project evidence.",
      evidenceContract: "Only a succeeded observation with matching project identity is usable evidence.",
      authorityConditions: ["The qualification project is approved for read access."],
      hardLimits: ["Read-only; no file mutation or command execution."],
      uncertainty: ["Failure leaves the semantic question unresolved."],
    ...
    },
    {
      ...
      description: "Run the approved read-only verification recipe.",
      inputContract: "Requires projectId and operator-bound workspaceId and recipeId.",
      outputContract: "Returns a verification effect receipt with mechanical evidence.",
      evidenceContract: "Only a succeeded receipt supports a verification claim.",
      authorityConditions: ["The qualification workspace and recipe are operator-bound."],
      hardLimits: ["Read-only; no file mutation, apply, commit, push, or deploy."],
      uncertainty: ["Failure or outcome_unknown leaves verification unsettled."],
