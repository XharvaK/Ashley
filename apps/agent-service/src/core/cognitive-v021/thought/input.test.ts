  ...
  it("removes operator project IDs when inspection affordances are filtered from non-Owner input", () => {
    const filtered = filterCapabilityReality({
      ...
      operationCapabilities: [{
        ...
        description: "Read an approved project file.",
        inputContract: "Requires projectId and path.",
        outputContract: "Returns a read-only observation.",
        evidenceContract: "Only a succeeded observation is usable evidence.",
        authorityConditions: ["The project must be approved."],
        hardLimits: ["Read-only."],
        uncertainty: ["Failure leaves the question unresolved."],
