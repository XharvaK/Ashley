...
export function mapReservation(row: unknown): DeliveryReservationRow | null {
  ...
  return {
    ...
    commitmentId: row.commitment_id == null ? null : text(row.commitment_id),
    commitmentOccurrenceId: row.commitment_occurrence_id == null ? null : text(row.commitment_occurrence_id),
    commitmentAttemptId: row.commitment_attempt_id == null ? null : text(row.commitment_attempt_id),
    speechOutboxId: num(row.speech_outbox_id),
